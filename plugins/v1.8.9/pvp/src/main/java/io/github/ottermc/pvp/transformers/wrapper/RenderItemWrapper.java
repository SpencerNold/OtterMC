...
public class RenderItemWrapper {
    ...
    private static final String renderItemClassName = "net/minecraft/client/renderer/entity/RenderItem";
    ...
    private static void renderModel(RenderItem renderer, IBakedModel model, int color) {
        Reflection.call(renderItemClassName, renderer, "renderModel", "(Lnet/minecraft/client/resources/model/IBakedModel;I)V", model, color);
    }
}
