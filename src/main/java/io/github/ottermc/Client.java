...
import io.github.ottermc.modules.hypixel.AutoTip;
import io.github.ottermc.modules.hypixel.GameMacro;
import io.github.ottermc.modules.hypixel.LevelHead;
import io.github.ottermc.modules.hypixel.TitleHead;
import io.github.ottermc.modules.hypixel.WinCounter;
...
public class Client implements PostInitializeListener {
	...
	// Separate options from new version options
	// add descriptions to mods without settings
	// make components position the same whether fullscreen or not
	// finish existing mods
...
//		adapter.register(GameSettingsTransformer.class);
	...
	public void onPostInitializeListener(PostInitializeEvent event) {
		...
		Display.setIcon(new ByteBuffer[] {
			Icon.readIconToBuffer("otter_icon_16x16.png"),
			Icon.readIconToBuffer("otter_icon_32x32.png"),
		});
		registerModules();
		registerHuds();
		storage.init();
	...
	private void registerModules() {
		...
		// TODO Steam like chat mod
		// TODO Music streaming mod
		// TODO Possible discord integration?
		...
		modManager.register(new AutoTip());
		modManager.register(new GameMacro());
		modManager.register(new LevelHead());
		modManager.register(new TitleHead());
		modManager.register(new WinCounter());
