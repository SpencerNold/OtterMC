...
import io.github.ottermc.events.listeners.AttackEntityListener.AttackEntityEvent;
...
public class PlayerControllerMPTransformer {
	...
	public void onAttackEntity(PlayerControllerMP controller, EntityPlayer player, Entity entity, Callback callback) {
		AttackEntityEvent event = new AttackEntityEvent(controller, player, entity);
		EventBus.fire(event);
	}
}
